...
cdef void Gas_neon(Gas* object):
    ...
    NBREM = 25
    XEN = gd['gas_neon/XEN']
    YXSEC = gd['gas_neon/YXSEC']
    XEL = gd['gas_neon/XEL']
    YEL = gd['gas_neon/YEL']
    XEPS = gd['gas_neon/XEPS']
    YEPS = gd['gas_neon/YEPS']
    XION = gd['gas_neon/XION']
    YION = gd['gas_neon/YION']
    YINC = gd['gas_neon/YINC']
    YIN1 = gd['gas_neon/YIN1']
    XIN2 = gd['gas_neon/XIN2']
    YIN2 = gd['gas_neon/YIN2']
    XIN3 = gd['gas_neon/XIN3']
    YIN3 = gd['gas_neon/YIN3']
    XKSH = gd['gas_neon/XKSH']
    YKSH = gd['gas_neon/YKSH']
    X1S5 = gd['gas_neon/X1S5']
    Y1S5 = gd['gas_neon/Y1S5']
    X1S4 = gd['gas_neon/X1S4']
    Y1S4 = gd['gas_neon/Y1S4']
    X1S3 = gd['gas_neon/X1S3']
    Y1S3 = gd['gas_neon/Y1S3']
    X1S2 = gd['gas_neon/X1S2']
    Y1S2 = gd['gas_neon/Y1S2']
    X2P10 = gd['gas_neon/X2P10']
    Y2P10 = gd['gas_neon/Y2P10']
    X2P9 = gd['gas_neon/X2P9']
    Y2P9 = gd['gas_neon/Y2P9']
    X2P8 = gd['gas_neon/X2P8']
    Y2P8 = gd['gas_neon/Y2P8']
    X2P7 = gd['gas_neon/X2P7']
    Y2P7 = gd['gas_neon/Y2P7']
    X2P6 = gd['gas_neon/X2P6']
    Y2P6 = gd['gas_neon/Y2P6']
    X2P5 = gd['gas_neon/X2P5']
    Y2P5 = gd['gas_neon/Y2P5']
    X2P4 = gd['gas_neon/X2P4']
    Y2P4 = gd['gas_neon/Y2P4']
    X2P3 = gd['gas_neon/X2P3']
    Y2P3 = gd['gas_neon/Y2P3']
    X2P2 = gd['gas_neon/X2P2']
    Y2P2 = gd['gas_neon/Y2P2']
    X2P1 = gd['gas_neon/X2P1']
    Y2P1 = gd['gas_neon/Y2P1']
    X2S5 = gd['gas_neon/X2S5']
    Y2S5 = gd['gas_neon/Y2S5']
    X2S3 = gd['gas_neon/X2S3']
    Y2S3 = gd['gas_neon/Y2S3']
    X3D6 = gd['gas_neon/X3D6']
    Y3D6 = gd['gas_neon/Y3D6']
    X3D4P = gd['gas_neon/X3D4P']
    Y3D4P = gd['gas_neon/Y3D4P']
    X3D4 = gd['gas_neon/X3D4']
    Y3D4 = gd['gas_neon/Y3D4']
    X3D3 = gd['gas_neon/X3D3']
    Y3D3 = gd['gas_neon/Y3D3']
    X3D1PP = gd['gas_neon/X3D1PP']
    Y3D1PP = gd['gas_neon/Y3D1PP']
    X3D1P = gd['gas_neon/X3D1P']
    Y3D1P = gd['gas_neon/Y3D1P']
    X3S1PPPP = gd['gas_neon/X3S1PPPP']
    Y3S1PPPP = gd['gas_neon/Y3S1PPPP']
    X3S1PPP = gd['gas_neon/X3S1PPP']
    Y3S1PPP = gd['gas_neon/Y3S1PPP']
    X3S1PP = gd['gas_neon/X3S1PP']
    Y3S1PP = gd['gas_neon/Y3S1PP']
    X3P106 = gd['gas_neon/X3P106']
    Y3P106 = gd['gas_neon/Y3P106']
    X3P52 = gd['gas_neon/X3P52']
    Y3P52 = gd['gas_neon/Y3P52']
    X3P1 = gd['gas_neon/X3P1']
    Y3P1 = gd['gas_neon/Y3P1']
    Z10T = gd['gas_neon/Z10T']
    EBRM = gd['gas_neon/EBRM']
    object.EnergyLevels = gd['gas_neon/EnergyLevels']
    for J in range(6):
