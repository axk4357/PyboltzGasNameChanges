...
cdef void Gas_ethane(Gas*object):
    ...
    XEN = gd['gas_ethane/XEN']
    YMT = gd['gas_ethane/YMT']
    YEL = gd['gas_ethane/YEL']
    YEPS = gd['gas_ethane/YEPS']
    XATT1 = gd['gas_ethane/XATT1']
    YATT1 = gd['gas_ethane/YATT1']
    XATT2 = gd['gas_ethane/XATT2']
    YATT2 = gd['gas_ethane/YATT2']
    XVIB1 = gd['gas_ethane/XVIB1']
    YVIB1 = gd['gas_ethane/YVIB1']
    XVIB2 = gd['gas_ethane/XVIB2']
    YVIB2 = gd['gas_ethane/YVIB2']
    XVIB3 = gd['gas_ethane/XVIB3']
    YVIB3 = gd['gas_ethane/YVIB3']
    XVIB4 = gd['gas_ethane/XVIB4']
    YVIB4 = gd['gas_ethane/YVIB4']
    XVIB5 = gd['gas_ethane/XVIB5']
    YVIB5 = gd['gas_ethane/YVIB5']
    XTR1 = gd['gas_ethane/XTR1']
    YTR1 = gd['gas_ethane/YTR1']
    XTR2 = gd['gas_ethane/XTR2']
    YTR2 = gd['gas_ethane/YTR2']
    XTR3 = gd['gas_ethane/XTR3']
    YTR3 = gd['gas_ethane/YTR3']
    XNUL1 = gd['gas_ethane/XNUL1']
    YNUL1 = gd['gas_ethane/YNUL1']
    XNUL2 = gd['gas_ethane/XNUL2']
    YNUL2 = gd['gas_ethane/YNUL2']
    XNUL3 = gd['gas_ethane/XNUL3']
    YNUL3 = gd['gas_ethane/YNUL3']
    XION1 = gd['gas_ethane/XION1']
    YION1 = gd['gas_ethane/YION1']
    XION2 = gd['gas_ethane/XION2']
    YION2 = gd['gas_ethane/YION2']
    XION3 = gd['gas_ethane/XION3']
    YION3 = gd['gas_ethane/YION3']
    XION4 = gd['gas_ethane/XION4']
    YION4 = gd['gas_ethane/YION4']
    XION5 = gd['gas_ethane/XION5']
    YION5 = gd['gas_ethane/YION5']
    XION6 = gd['gas_ethane/XION6']
    YION6 = gd['gas_ethane/YION6']
    XION7 = gd['gas_ethane/XION7']
    YION7 = gd['gas_ethane/YION7']
    XION8 = gd['gas_ethane/XION8']
    YION8 = gd['gas_ethane/YION8']
    XION9 = gd['gas_ethane/XION9']
    YION9 = gd['gas_ethane/YION9']
    XION10 = gd['gas_ethane/XION10']
    YION10 = gd['gas_ethane/YION10']
    XION11 = gd['gas_ethane/XION11']
    YION11 = gd['gas_ethane/YION11']
    XION12 = gd['gas_ethane/XION12']
    YION12 = gd['gas_ethane/YION12']
    XION13 = gd['gas_ethane/XION13']
    YION13 = gd['gas_ethane/YION13']
    XION14 = gd['gas_ethane/XION14']
    YION14 = gd['gas_ethane/YION14']
    XION15 = gd['gas_ethane/XION15']
    YION15 = gd['gas_ethane/YION15']
    XION16 = gd['gas_ethane/XION16']
    YION16 = gd['gas_ethane/YION16']
    XION = gd['gas_ethane/XION']
    YIONG = gd['gas_ethane/YIONG']
    YIONC = gd['gas_ethane/YIONC']
    Z1T = gd['gas_ethane/Z1T']
    Z6T = gd['gas_ethane/Z6T']
    EBRM = gd['gas_ethane/EBRM']
    ...
    object.EnergyLevels = gd['gas_ethane/EnergyLevels']
