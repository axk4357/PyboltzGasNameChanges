...
cdef void Gas_argon(Gas *object):
    ...
    object.EnergyLevels = gd['gas_argon/EnergyLevels']
    XEN = gd['gas_argon/XEN']
    YSEC = gd['gas_argon/YSEC']
    YEL = gd['gas_argon/YEL']
    XEPS = gd['gas_argon/XEPS']
    YEPS = gd['gas_argon/YEPS']
    XENI = gd['gas_argon/XENI']
    YENI = gd['gas_argon/YENI']
    YENC = gd['gas_argon/YENC']
    YEN1 = gd['gas_argon/YEN1']
    XEN2 = gd['gas_argon/XEN2']
    YEN2 = gd['gas_argon/YEN2']
    XEN3 = gd['gas_argon/XEN3']
    YEN3 = gd['gas_argon/YEN3']
    XKSH = gd['gas_argon/XKSH']
    YKSH = gd['gas_argon/YKSH']
    XL1S = gd['gas_argon/XL1S']
    YL1S = gd['gas_argon/YL1S']
    XL2S = gd['gas_argon/XL2S']
    YL2S = gd['gas_argon/YL2S']
    XL3S = gd['gas_argon/XL3S']
    YL3S = gd['gas_argon/YL3S']
    X1S5 = gd['gas_argon/X1S5']
    Y1S5 = gd['gas_argon/Y1S5']
    YEPS1 = gd['gas_argon/YEPS1']
    X1S4 = gd['gas_argon/X1S4']
    Y1S4 = gd['gas_argon/Y1S4']
    YEPS2 = gd['gas_argon/YEPS2']
    X1S3 = gd['gas_argon/X1S3']
    Y1S3 = gd['gas_argon/Y1S3']
    YEPS3 = gd['gas_argon/YEPS3']
    X1S2 = gd['gas_argon/X1S2']
    Y1S2 = gd['gas_argon/Y1S2']
    YEPS4 = gd['gas_argon/YEPS4']
    X2P10 = gd['gas_argon/X2P10']
    Y2P10 = gd['gas_argon/Y2P10']
    YEP2P10 = gd['gas_argon/YEP2P10']
    X2P9 = gd['gas_argon/X2P9']
    Y2P9 = gd['gas_argon/Y2P9']
    YEP2P9 = gd['gas_argon/YEP2P9']
    X2P8 = gd['gas_argon/X2P8']
    Y2P8 = gd['gas_argon/Y2P8']
    YEP2P8 = gd['gas_argon/YEP2P8']
    X2P7 = gd['gas_argon/X2P7']
    Y2P7 = gd['gas_argon/Y2P7']
    YEP2P7 = gd['gas_argon/YEP2P7']
    X2P6 = gd['gas_argon/X2P6']
    Y2P6 = gd['gas_argon/Y2P6']
    YEP2P6 = gd['gas_argon/YEP2P6']
    X2P5 = gd['gas_argon/X2P5']
    Y2P5 = gd['gas_argon/Y2P5']
    YEP2P5 = gd['gas_argon/YEP2P5']
    X2P4 = gd['gas_argon/X2P4']
    Y2P4 = gd['gas_argon/Y2P4']
    YEP2P4 = gd['gas_argon/YEP2P4']
    X2P3 = gd['gas_argon/X2P3']
    Y2P3 = gd['gas_argon/Y2P3']
    YEP2P3 = gd['gas_argon/YEP2P3']
    X2P2 = gd['gas_argon/X2P2']
    Y2P2 = gd['gas_argon/Y2P2']
    YEP2P2 = gd['gas_argon/YEP2P2']
    X2P1 = gd['gas_argon/X2P1']
    Y2P1 = gd['gas_argon/Y2P1']
    YEP2P1 = gd['gas_argon/YEP2P1']
    X3D6 = gd['gas_argon/X3D6']
    Y3D6 = gd['gas_argon/Y3D6']
    YEP3D6 = gd['gas_argon/YEP3D6']
    X3D5 = gd['gas_argon/X3D5']
    Y3D5 = gd['gas_argon/Y3D5']
    YEP3D5 = gd['gas_argon/YEP3D5']
    X3D4P = gd['gas_argon/X3D4P']
    Y3D4P = gd['gas_argon/Y3D4P']
    YEP3D4P = gd['gas_argon/YEP3D4P']
    X3D4 = gd['gas_argon/X3D4']
    Y3D4 = gd['gas_argon/Y3D4']
    YEP3D4 = gd['gas_argon/YEP3D4']
    X3D3 = gd['gas_argon/X3D3']
    Y3D3 = gd['gas_argon/Y3D3']
    YEP3D3 = gd['gas_argon/YEP3D3']
    X3D1PP = gd['gas_argon/X3D1PP']
    Y3D1PP = gd['gas_argon/Y3D1PP']
    YEP3D1PP = gd['gas_argon/YEP3D1PP']
    X3D1P = gd['gas_argon/X3D1P']
    Y3D1P = gd['gas_argon/Y3D1P']
    YEP3D1P = gd['gas_argon/YEP3D1P']
    X3S1PPPP = gd['gas_argon/X3S1PPPP']
    Y3S1PPPP = gd['gas_argon/Y3S1PPPP']
    YEP3S1PPPP = gd['gas_argon/YEP3S1PPPP']
    X3S1PPP = gd['gas_argon/X3S1PPP']
    Y3S1PPP = gd['gas_argon/Y3S1PPP']
    YEP3S1PPP = gd['gas_argon/YEP3S1PPP']
    X3S1PP = gd['gas_argon/X3S1PP']
    Y3S1PP = gd['gas_argon/Y3S1PP']
    YEP3S1PP = gd['gas_argon/YEP3S1PP']
    X2S5 = gd['gas_argon/X2S5']
    Y2S5 = gd['gas_argon/Y2S5']
    YEP2S5 = gd['gas_argon/YEP2S5']
    X2S3 = gd['gas_argon/X2S3']
    Y2S3 = gd['gas_argon/Y2S3']
    YEP2S3 = gd['gas_argon/YEP2S3']
